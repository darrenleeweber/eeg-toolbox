function [mri] = freesurfer_read_cor_gui(mri,command,parent)

% freesurfer_read_cor_gui - Load & Display FreeSurfer COR-??? data
%
% Useage: [mri] = freesurfer_read_cor_gui(mri,[command],[parent])
%
...
switch command,
    ...
    case 'save',
        ...
        fprintf('\nfreesurfer_read_cor_gui: Save As not implemented yet.\n');
...
G.Bplot = uicontrol('Parent',GUI,'Style','pushbutton','Units','Normalized', Font, ...
    ...
    'ForegroundColor', [1 1 1], 'HorizontalAlignment', 'center',...
    'Callback',strcat('MRIOpen = get(gcbf,''Userdata'');',...
    'mri = freesurfer_read_cor_gui(MRIOpen.mri,''plot'');',...
    'clear MRIOpen;'));
...
G.Bsave = uicontrol('Parent',GUI,'Style','pushbutton','Units','Normalized', Font, ...
    ...
    'ForegroundColor', [1 1 1], 'HorizontalAlignment', 'center',...
    'Callback',strcat('MRIOpen = get(gcbf,''Userdata'');',...
    'mri = freesurfer_read_cor_gui(MRIOpen.mri,''save'');',...
    'clear MRIOpen;'));
...
G.Breturn = uicontrol('Parent',GUI,'Style','pushbutton','Units','Normalized', Font, ...
    ...
    'ForegroundColor', [1 1 1], 'HorizontalAlignment', 'center',...
    'Callback',strcat('MRIOpen = get(gcbf,''Userdata'');',...
    'mri = freesurfer_read_cor_gui(MRIOpen.mri,''return'');',...
    'clear MRIOpen;'));
...
G.Bcancel = uicontrol('Parent',GUI,'Style','pushbutton','Units','Normalized', Font, ...
    ...
    'ForegroundColor', [1 1 1], 'HorizontalAlignment', 'center',...
    'Callback',strcat('MRIOpen = get(gcbf,''Userdata'');',...
    'mri = freesurfer_read_cor_gui(MRIOpen.mri,''cancel'');',...
    'clear MRIOpen;'));
