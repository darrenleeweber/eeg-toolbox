function [ p ] = elec_sph_refine(p)

% ELEC_SPH_REFINE - creates spherical vertices between input vertices
%
% [ p ] = elec_sph_refine( p )
%
...
% especially the spherical projections created by elec_proj_sph.
% 
...
tic;
fprintf('ELEC_SPH_REFINE: processing faces...');
