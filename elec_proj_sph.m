function [r,x,y,z] = elec_proj_sph(X,Y,Z,xo,yo,zo,varargin)

% elec_proj_sph - calculates spherical projections of electrode positions
%
% Usage: [r,x,y,z] = elec_proj_sph(X,Y,Z,xo,yo,zo,[estim],[plot])
%
...
% $Revision: 1.11 $ $Date: 2004/04/16 18:49:10 $
...
eegversion = '$Revision: 1.11 $';
fprintf('ELEC_PROJ_SPH [v %s]\n',eegversion(11:15)); tic
