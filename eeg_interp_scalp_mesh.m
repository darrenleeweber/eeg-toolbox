...
% $Revision: 1.11 $ $Date: 2004/03/29 21:15:19 $
...
scalpvert = p.meshData.vertices{3};
scalpface = p.meshData.faces{3};
elecvert  = p.meshData.vertices{4};
elecface  = p.meshData.faces{4};
